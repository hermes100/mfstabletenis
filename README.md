...
<本体>
  ...
  <div class = "top-wrapper">
    <div class = "container">
      ...
      <p> Progateはオンラインプログラミング学習です。<br>ここややさしいそうと甲で、テストサービスを作成するプログラミングを学んでいきましょう。</ p>
    ...
    <div class = "container">
      ...
      <div class = "lessons">
        <div class = "lesson">
          ...
          <pclass = "text-contents">クラスリストの作成に使用する言語です。
        </ div>
        <div class = "lesson">
          <div class = "lesson-icon">
          ...
          <p class = "text-contents">記憶なこを手軽に受けましたJavaScriptれでき、Ajax（エイジャックス）をなして、 p>
        </ div>
        <div class = "lesson">
          <div class = "lesson-icon">
        ...
        <div class = "lesson">
          ...
          <p class = "text-contents"> HTMLだけでコンテンツをコンテンツはできません。PHPはHTMLにプログラムを埋め込みます。</ p>
        </ div>
      </ div>
      <div class = "clear"> </ div>
    </ div>
  ...
  <div class = "message-wrapper">
    <div class = "container">
      <div class = "heading">
        <h2>さぁ、あなたもプロゲートでデモを学んでみませんか？</ h2>
